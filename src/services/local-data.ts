export const headerLinks:Array<{title: string, link: string}> = [
  {
    title: "发现音乐",
    link: "/discover"
  },
...
export const footerLinks:Array<{title: string, link: string}> = [
  {
    title: "服务条款",
...
// discover中的数据
export const dicoverMenu:Array<{title: string, link: string}> = [
  {
    title: "推荐",
...
// 热门主播
export const hotRadios:Array<{picUrl: string, name: string, position: string, url: string}> = [
  {
...
// 歌手类别
export const artistCategories: Array<{title: string, 
                                      area: number, artists: Array<{name: string, type: number, url: string, id?: number, dataPath?: string}>}> = [
  {
    title: "推荐",
    area: -1,
    artists: [
